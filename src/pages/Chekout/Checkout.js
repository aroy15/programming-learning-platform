...
const Checkout = () => {
    const { course_title, details_overview, image_url } = useLoaderData()
    return (
        <Card className="bg-dark text-dark">
            ...
            <Card.ImgOverlay className="d-flex flex-column align-items-center justify-content-center">
                <div className='card-text p-3 rounded shadow-lg w-100' style={{backgroundColor:'rgba(194,211,244,0.90)',maxWidth:'500px'}}>                    
